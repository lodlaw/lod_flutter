...
class CupertinoOutlineButton extends StatefulWidget {
  /// Creates an iOS-style button.
  const CupertinoOutlineButton({
    Key? key,
    required this.child,
    this.padding,
    this.color,
  ...
  /// default constructor.
  const CupertinoOutlineButton.filled({
    Key? key,
    required this.child,
    this.padding,
    this.disabledColor = CupertinoColors.quaternarySystemFill,
...
class _CupertinoButtonState extends State<CupertinoOutlineButton>
  ...
  @override
  void didUpdateWidget(CupertinoOutlineButton old) {
